...
update "Adresses" set "Number" = '394', "District" = null, "Description" = 'Rua Clovis de Holanda Calado' where "Description" = 'Rua Clovis de Holanda Calado, 394';
...
select count(*), uv."UnitName", uv."CityId", c."Name", uv."UnityType" from "UserVaccines" uv
inner join "Cities" c on c."Id" = uv."CityId"
group by uv."UnitName", uv."CityId", c."Name", uv."UnityType";

#Afogados da Ingazeira" VIGILANCIA EM SAUDE
update "UserVaccines" set "HealthUnitId" = (select "Id" from "HealthUnits" where "Name" = 'Vigilância em Saúde') where "CityId" = '2f18853f-1768-49b3-a4cb-b52b551d970c' and "UnityType" = '1';

#Recife Drive Thru Arruda
update "UserVaccines" set "HealthUnitId" = (select "Id" from "HealthUnits" where "Name" = 'Drive Thru Arruda') where "CityId" = '6781964b-c7a8-4524-b871-257bf77962db' and "UnityType" = '1';

#Santos SEUB Gonzaga
update "UserVaccines" set "HealthUnitId" = (select "Id" from "HealthUnits" where "Name" = 'SEUB Gonzaga') where "CityId" = '05d9c27e-4cc8-4bfd-8e95-d4b56fb8233c' and "UnityType" = '1';

#São Paulo UBS Jardim Helena
update "UserVaccines" set "HealthUnitId" = (select "Id" from "HealthUnits" where "Name" = 'UBS Jardim Helena') where "CityId" = '97d5e825-645f-4451-8066-795183138215' and "UnityType" = '1';

#Recife HOPE
update "UserVaccines" set "HealthUnitId" = (select "Id" from "HealthUnits" where "Name" = 'HOPE') where "CityId" = '6781964b-c7a8-4524-b871-257bf77962db' and "UnityType" = '2';

#Olinda SEC Saude Olinda
update "UserVaccines" set "HealthUnitId" = (select "Id" from "HealthUnits" where "Name" = 'SEC Saúde Olinda') where "CityId" = 'a1c4d1b0-bd43-4a7e-8682-0551ce772f9b' and "UnityType" = '1';

#João Pessoa Unidade de Saúde Familiar Móvel
update "UserVaccines" set "HealthUnitId" = (select "Id" from "HealthUnits" where "Name" = 'Unidade de Saúde Familiar Móvel') where "CityId" = '55aee2fe-921b-42e7-b9c6-d357b0e0e272' and "UnityType" = '1';

#Salvador
INSERT INTO "Adresses" ("Id", "CityId", "Description", "CreateDate", "UpdateDate")
VALUES (uuid_generate_v4(), 'a37c98c8-4dad-4fee-8295-bf600e64a0c2', 'Endereço Unidade Salvador Tipo Pública', timezone('utc', now()), timezone('utc', now()));

INSERT INTO "HealthUnits" ("Id", "Name", "TypeId", "AddressId", "CreateDate", "UpdateDate")
VALUES (uuid_generate_v4(), 'Unidade Salvador Apple', (select "Id" from "HealthUnitTypes" where "Name" = 'Pública'), (select "Id" from "Adresses" where "Description" = 'Endereço Unidade Salvador Tipo Pública'), timezone('utc', now()), timezone('utc', now()));

update "UserVaccines" set "HealthUnitId" = (select "Id" from "HealthUnits" where "Name" = 'Unidade Salvador Apple') where "CityId" = 'a37c98c8-4dad-4fee-8295-bf600e64a0c2' and "UnityType" = '1';
