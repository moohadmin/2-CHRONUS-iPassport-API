    ...
    public static class UserImportDtoSeed
    {
        private static UserImportDto UserImportDtoComplete()
            => new()
            {
                ...
                BatchUniqueDose = "123",
                VaccinationDateUniqueDose = DateTime.UtcNow,
                ...
                BatchFirstDose = "456",
                VaccinationDateFirstDose = DateTime.UtcNow,
                ...
                BatchSecondDose = "789",
                VaccinationDateSecondDose = DateTime.UtcNow,
                ...
                BatchThirdDose = "012",
                VaccinationDateThirdDose = DateTime.UtcNow,
