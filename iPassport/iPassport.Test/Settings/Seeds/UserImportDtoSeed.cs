    ...
    public static class UserImportDtoSeed
    {
        private static UserImportDto UserImportDtoComplete()
            => new()
            {
                ...
                BatchUniqueDose = "123",
                VaccinationDateUniqueDose = DateTime.Now.AddDays(-1),
                ...
                BatchFirstDose = "456",
                VaccinationDateFirstDose = DateTime.Now.AddDays(-1),
                ...
                BatchSecondDose = "789",
                VaccinationDateSecondDose = DateTime.Now.AddDays(-1),
                ...
                BatchThirdDose = "012",
                VaccinationDateThirdDose = DateTime.Now.AddDays(-1),
