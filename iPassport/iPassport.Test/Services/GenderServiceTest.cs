...
namespace iPassport.Test.Services
{
    ...
    {
        Mock<IGenderRepository> _mockRepository;
        ...
        public void Setup()
        {
            ...
            _mockRepository = new Mock<IGenderRepository>();
            _mockLocalizer = new Mock<IStringLocalizer<Resource>>();

            _service = new GenderService(_mockRepository.Object, _mockLocalizer.Object, _mapper);
        }
        ...
        public void FindByNameParts_MustReturnOk()
        {
            ...
            _mockRepository.Setup(x => x.FindByNameParts(It.IsAny<GetByNamePartsPagedFilter>()).Result).Returns(GenderSeed.GetPaged());
