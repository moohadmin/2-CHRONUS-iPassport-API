...
{
    [TestClass]
    public class HumanRaceControllerTest
    {
        Mock<IHumanRaceService> _mockService;
        IMapper _mapper;
        HumanRaceController _controller;

        [TestInitialize]
        public void Setup()
        {
            _mockService = new Mock<IHumanRaceService>();
            _mapper = AutoMapperFactory.Create();
            _controller = new HumanRaceController(_mapper, _mockService.Object);
        }
