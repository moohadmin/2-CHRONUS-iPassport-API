...
namespace iPassport.Infra.Migrations.PassportIdentity
{
    ...
    [Migration("20210503210119_Update_Users_Remove_Colunm_LastLogin_UserType_DesactivationDate_DesactivationId_Gender_Breed_BloodType")]
    partial class Update_Users_Remove_Colunm_LastLogin_UserType_DesactivationDate_DesactivationId_Gender_Breed_BloodType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iPassport.Domain.Entities.Authentication.Users", b =>
                {
                    ...
                    b.Property<string>("CorporateCellphoneNumber")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("iPassport.Domain.Entities.UserType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("iPassport.Domain.Entities.UserUserType", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("iPassport.Domain.Entities.UserUserType", b =>
                {
                    ...
                    b.HasOne("iPassport.Domain.Entities.Authentication.Users", "User")
                        .WithMany("UserUserTypes")
                        .HasForeignKey("UserId")
                        .IsRequired();

                    b.HasOne("iPassport.Domain.Entities.UserType", "UserType")
                        .WithMany("UserUserTypes")
