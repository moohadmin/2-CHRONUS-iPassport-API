...
namespace iPassport.Api.Models.Validators.Company
{
    ...
    /// </summary>
    public class CompanyResponsibleCreateRequestValidator : AbstractValidator<CompanyResponsibleCreateRequest>
    {
        /// <summary>
        /// Class Constructor
        /// </summary>
        /// <param name="localizer">String localizer</param>
        public CompanyResponsibleCreateRequestValidator(IStringLocalizer<Resource> localizer)
        {
            RuleFor(x => x.Name)
                .NotEmpty()
