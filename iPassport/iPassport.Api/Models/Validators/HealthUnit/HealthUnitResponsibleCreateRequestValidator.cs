...
namespace iPassport.Api.Models.Validators.HealthUnit
{
    ...
    /// </summary>
    public class HealthUnitResponsibleCreateRequestValidator : AbstractValidator<HealthUnitResponsibleCreateRequest>
    {
        /// <summary>
        /// Class Constructor
        /// </summary>
        /// <param name="localizer">String localizer</param>
        public HealthUnitResponsibleCreateRequestValidator(IStringLocalizer<Resource> localizer)
        {
            RuleFor(x => x.Name)
                .NotEmpty()
